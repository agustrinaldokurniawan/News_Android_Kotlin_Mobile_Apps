...
public abstract class a {
    public final g.e.a<String, Method> a;
    public final g.e.a<String, Method> b;

    /* renamed from: c  reason: collision with root package name */
    public final g.e.a<String, Class> f3067c;

    public a(g.e.a<String, Method> aVar, g.e.a<String, Method> aVar2, g.e.a<String, Class> aVar3) {
        this.a = aVar;
        this.b = aVar2;
        this.f3067c = aVar3;
    }
    ...
    public final Class c(Class<? extends c> cls) {
        Class orDefault = this.f3067c.getOrDefault(cls.getName(), null);
        if (orDefault != null) {
            return orDefault;
        }
        Class<?> cls2 = Class.forName(String.format("%s.%sParcelizer", cls.getPackage().getName(), cls.getSimpleName()), false, cls.getClassLoader());
        this.f3067c.put(cls.getName(), cls2);
        return cls2;
    }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r5v0, resolved type: g.w.a */
