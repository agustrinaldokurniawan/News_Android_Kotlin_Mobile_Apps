...
public abstract class s0 {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ ArrayList f2769f;

        /* renamed from: g  reason: collision with root package name */
        public final /* synthetic */ ArrayList f2770g;

        /* renamed from: h  reason: collision with root package name */
        public final /* synthetic */ ArrayList f2771h;

        /* renamed from: i  reason: collision with root package name */
        public final /* synthetic */ ArrayList f2772i;

        public a(s0 s0Var, int i2, ArrayList arrayList, ArrayList arrayList2, ArrayList arrayList3, ArrayList arrayList4) {
            this.e = i2;
            this.f2769f = arrayList;
            this.f2770g = arrayList2;
            this.f2771h = arrayList3;
            this.f2772i = arrayList4;
        }

        public void run() {
            for (int i2 = 0; i2 < this.e; i2++) {
                AtomicInteger atomicInteger = o.a;
                ((View) this.f2769f.get(i2)).setTransitionName((String) this.f2770g.get(i2));
                ((View) this.f2771h.get(i2)).setTransitionName((String) this.f2772i.get(i2));
            }
        }
    }
